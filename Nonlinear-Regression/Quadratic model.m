...
%% Increase the linearity of the nonlinear data by Quadratic model
 % This file is used to test the Quadratic model for the goal of achieve the
...
Rs_t=rs_t/20
figure;
plot(TestY,residual,'+');title('Quadratic model Residual');
